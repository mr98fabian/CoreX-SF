...
export default function FreedomCounter({ freedom, streak }: Props) {
    ...
    return (
        <Card className="border-slate-800 bg-slate-950/50 backdrop-blur-sm overflow-hidden relative h-full">
            {/* Subtle ambient glow */}
            ...
            <CardContent className="px-4 pb-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="rounded-lg bg-slate-800/30 border border-slate-700/30 p-2.5">
                        <div className="flex items-center gap-1 mb-0.5">
                            ...
                            <span className="text-[10px] text-slate-500">KoreX Target</span>
                        </div>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-800">
                    <div>
                        <p className="text-[10px] text-slate-500">Months Accelerated</p>
                        <p className="text-base font-bold font-mono text-emerald-400">
                            {freedom.months_saved}
                        </p>
                    </div>
                    <div className="text-right">
                        <p className="text-[10px] text-slate-500">Attack Streak</p>
