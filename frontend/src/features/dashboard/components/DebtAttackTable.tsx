...
export default function DebtAttackTable() {
    ...
    return (
        <Card className="border-gray-200 dark:border-neutral-800 bg-white/50 dark:bg-black/50 backdrop-blur-xl">
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 relative overflow-hidden group">
                                ...
                                <div className="flex justify-between items-start relative mb-4">
                                    <div>
                                        ...
                                        <div className="text-sm text-gray-500 dark:text-gray-400">{velocityTarget.apr}% APR</div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="flex-1 space-y-1">
                                        <div className="flex justify-between text-xs">
                                            <span className="text-gray-500 dark:text-gray-400">Attack Progress</span>
                                            <span className="text-amber-400 font-mono">
                                                {velocityAmount > 0 ? 'ACCELERATED' : 'STANDARD'}
                                            </span>
                                        </div>
                                        <Progress value={35} className="h-2 bg-gray-200 dark:bg-[#0f0f0f]" indicatorClassName="bg-amber-500" />
                                    </div>
                                    ...
                                    >
                                        <Button className="bg-amber-600 hover:bg-neutral-800 text-white font-bold shadow-lg shadow-amber-900/20 animate-pulse">
                        ...
                        <div className="rounded-lg border border-gray-200 dark:border-zinc-800 overflow-hidden">
                            <table className="w-full text-sm">
                                <thead className="bg-gray-100/80 dark:bg-[#0f0f0f]/50 text-gray-500 dark:text-zinc-400">
                                ...
                                <tbody className="divide-y divide-slate-200 dark:divide-zinc-800/50">
                                    {consolidatedDebts.map((account) => (
                                        <tr key={account.id} className="group hover:bg-gray-50 dark:hover:bg-[#0f0f0f]/50 transition-colors">
                                            ...
                                            <td className="py-3 px-4 text-right text-gray-400 dark:text-zinc-400">
