...
const HELP_CONTENT: Record<string, HelpContent> = {
    ...
    morningBriefing: {
        ...
        icon: '🌅',
        description: 'Your daily financial briefing — KoreX analyzes your current position and recommends the optimal debt move.',
        descriptionEs: 'Tu informe financiero diario — KoreX analiza tu posición actual y recomienda el movimiento de deuda óptimo.',
        bullets: [
            { icon: '💡', text: 'Recommended Action: How much to move and to which debt', textEs: 'Acción Recomendada: Cuánto mover y a cuál deuda' },
            { icon: '📈', text: 'Impact Metrics: Days accelerated, monthly savings, and freedom hours gained', textEs: 'Métricas de Impacto: Días acelerados, ahorro mensual y horas de libertad ganadas' },
            { icon: '🎯', text: 'Target Selection: Always attacks your highest APR debt first', textEs: 'Selección de Objetivo: Siempre ataca tu deuda con mayor APR primero' },
            { icon: '🔗', text: 'Execute from the Action Plan page for step-by-step instructions', textEs: 'Ejecuta desde la página de Plan de Acción para instrucciones paso a paso' },
        ],
        location: '📍 Execute: Action Plan page → Follow the steps',
        locationEs: '📍 Ejecutar: Página de Plan de Acción → Sigue los pasos',
    },
    heatCalendar: {
